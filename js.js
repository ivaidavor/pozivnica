    document.getElementById('navigate-button').addEventListener('click', function() {
        window.open('https://www.google.com/maps/dir/?api=1&destination=43.4796018538303, 17.32963655268474', '_blank')
    });

    document.getElementById('wedding-location').addEventListener('click', function() {
        window.open('https://www.google.com/maps/place/43.47477,17.32965', '_blank')
    });
